...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("My Cart",style: GoogleFonts.inter(
            fontSize: 18,
      ...
      body: Obx(() =>
      userController.userData.value.cart?.length !=0 ?
          Column(
        children: [
          Expanded(
            child: AnimationLimiter(
              child: ListView.builder(
                  itemCount: userController.userData.value.cart?.length,
                  shrinkWrap: true,
                      ...
                      child: SlideAnimation(
                        ...
                        child: FadeInAnimation(
                          child: ShowCartWidget(
                            cartItemModel: userController.userData.value.cart![i] ,
                          ),
                        ),
                      ),
                    );
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text("RS.${cartController.totalCartPrice.value}",style: GoogleFonts.inter(
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                        color: kButtonColor
                    ),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Text("Proceed to checkout",style: GoogleFonts.inter(
                            fontSize: 18,
                            fontWeight: FontWeight.w600,
                            color: Colors.white
                        ),),
